...
{         
     ...
     flagwaitctrAngle=1;
     //sa=angle/2;// set gia tri khoang cach di chuyen chia doi cho di chuyen 2 banh
...
//           hc(5,40);wn16s(cmdCtrlRobot); 
//         hc(4,40);wn16s(idRobot);
//         hc(3,40);wn16s(flagtask); 
//             
//         //delay_ms(100);
         switch (idRobot)
         {
...
//     //khong thay truyen tinh hieu robot 
//     if(flagstatus==0)    cntunsignalRF ++;
//     else
//     {
//       cntunsignalRF=0;
//     }
//     if(cntunsignalRF > 10000)  // xac nhan mat tin hieu RF
//     {
//        flagunsignalRF=1;
//     }else flagunsignalRF=0;
//     if(cntunlookRB > 10)  // xac nhan robot roi vao diem mu
//     {
//        flagunlookRB=1;        
//     }else  flagunlookRB=0; 
     return flagstatus;
...
//            if (IRFL>300 && IRFR<300)
//            {
//             vMLlui(5);vMRlui(22);delay_ms(300);
//            }
//            if (IRFR>300 && IRFL<300 )
//            {
//            vMLlui(22);vMRlui(5);delay_ms(300);
//            }
//        } 
        ...
        LEDBR=!LEDBR;
       // delay_ms(10);    
       readposition();//doc RF cap nhat lai robot
    }
}
...
int macdinh()
{
     ...
     if(readposition()==1)//co du lieu moi
      {  
           if(cmdCtrlRobot==5)  //set vi tri penalty robot
            {                                           
                calcvitri( rbctrlHomeX, rbctrlHomeY);
                if(distance>50) //chay den vi tri 
                {
    ...
    //PHUC
       ...
       case 5:
            ...
            {  
              ...
              rbctrlHomeX =242 ;
              rbctrlHomeY = -10.2  ;
              setRobotXmin=-100; //-270 
              setRobotXmax=100;  //270
            }
       break;
       case 6:
...
//////        hc(5,40);wn16s(orentation); 
//////        hc(4,40);wn16s(flagtancong); 
////     //=========================================================   PHUC ID
////    //XEP HANG THEO TOA DO CHO TRUOC
////        ctrrobot();// can phai luon luon chay de dieu khien robot
////       //rb_move(245,3.3);  //4   
////        rb_move(114,91);  //6 
////       // rb_move(122.6,-80.4);  //5
////       //rb_move(-102,-58.5);  //3  
////       // rb_move(-112,108.5);  //2          
////       // rb_move(-181,16);  //1
////       rb_wait(500000);
